          ...
          <div class="nav-con">
            <ul class="normal-nav layui-clear" id="categoryUl">
              ...
              <c:forEach items="category" var="category">
                <li class="nav-item">
                  <c:if test="${cate.categoryName==null}">
                    <div class="title">${category.categoryName}</div>
                  </c:if>
                  <c:if test="${category.parentId!=null}">
                    <c:forEach items="${category.categoryList}" var="cate">
                      <p><a href="#">${cate.categoryName}</a></p>
    ...
    <div class="product-list-box" id="product-list-box">
      <div class="product-list-cont w1200">
        ...
        <div class="product-item-box layui-clear">
          ...
          <c:forEach items="${sessionScope.animals}" var="ani">
            <div class="list-item" id="recommendAnimal">
              <a href="javascript:;"><img src="${ani.img}"></a>
              <p>${ani.title}</p>
              <span>￥${ani.ciurPic}</span>
            </div>
          </c:forEach>
          ...
          $.post(
              ...
              function (res) {
                ...
                <i class="layui-icon layui-icon-right"></i>
                      ...
                      var div=$("<div class=\"title\"></div>").text(res);
                      var p=$("<p></p>").html()
                  }
              }
          )
